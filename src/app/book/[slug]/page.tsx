...
export default async function BookReviewPage({
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-8 px-4 pb-16 pt-10 sm:pt-12">
      <Link
        href="/book"
        className="text-xs uppercase tracking-[0.3em] text-slate-500 no-underline transition hover:text-slate-700 hover:no-underline dark:text-zinc-400 dark:hover:text-zinc-200"
      >
        ← Back to book reviews
      </Link>

      <article className="space-y-8">
        <header className="grid gap-6 border-b border-stone-300 pb-8 dark:border-zinc-800 sm:grid-cols-[1fr,140px] sm:items-start">
          ...
          {book.image ? (
            <div className="relative aspect-[3/4] w-28 overflow-hidden border border-stone-300 bg-[hsl(42_35%_92%)] p-1 dark:border-zinc-700 dark:bg-zinc-800">
              <Image
                src={book.image}
        ...
        <div className="space-y-5 text-base leading-8 text-slate-700 dark:text-zinc-200">
